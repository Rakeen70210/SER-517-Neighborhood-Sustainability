# This script parse file downloaded from https://www2.census.gov/programs-surveys/economic-census/data/2017/sector00/EC1700BASIC.zip
# and adds values for columns present in "t_and_i_columns" to output csv
...
# parses the xlsx file and returns a details for "key = city_name + ":" + state_code"
